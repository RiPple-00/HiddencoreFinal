...
import GalleryPage from "./src/pages/guardian/activePhoto/GalleryPage";
...
export default function App() {
  ...
  // const [screen, setScreen] = useState({ name: 'gallery', range: 'today' });

  // if (screen.name === 'more') {
  //   return (
  //     <GuardianMorePage
  //       range={screen.range}
  //       onBack={() => setScreen({ name: 'gallery', range: 'today' })}
  //     />
  //   );
  // }
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="GuardianMain">
        ...
        {/* <GuardianGalleryPage
      onOpenMore={(range) => setScreen({ name: 'more', range })}
      onBack={() => {}}
    /> */}
