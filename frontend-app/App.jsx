...
// import { styles } from "./src/styles/guardianMain.styles";
// import {
//   SafeAreaView,
//   View,
//   Text,
...
//                 <View style={styles.mealTextWrap}> {/*여기는 태우 컴포넌트 받와서 할 예정 */}
...
import StoragePage from "./pages/billing/StoragePage";
import StorageList from "./components/billing/StorageList";
import StorageDetail from "./components/billing/StorageDetail";
import PaymentHistory from "./components/billing/PaymentHistory";
import InvoicePaymentList from "./components/billing/InvoicePayentList";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/pay-story"            element={<PaymentHistory />} />
      <Route path="/invoice-payment-list" element={<InvoicePaymentList />} />
    </Routes>
  );
}
