...
public class LocationController {
    ...
    public ResponseEntity<List<LocationDto.RoomPatientCountDto>> getRoomSummary(
    ...
    public ResponseEntity<LocationDto.RoomPatientCountDto> getRoomPatientCount(
        ...
        LocationDto.RoomPatientCountDto response = locationService.getRoomPatientCount(building, floor, room);
