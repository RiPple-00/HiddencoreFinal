...
import hiddencore.ddasum.backend.service.Storage.StorageService;
...
public class StorageController {
	...
	public ResponseEntity<StorageDto.PatientSearchResponse> searchPatients(
			@Valid @ModelAttribute StorageDto.PatientSearchRequest request) {
	...
	public ResponseEntity<StorageDto.InvoiceSearchResponse> searchInvoices(
			@Valid @ModelAttribute StorageDto.InvoiceSearchRequest request) {
	...
	public ResponseEntity<StorageDto.PaymentHistorySearchResponse> getPaymentHistories(
			@Valid @ModelAttribute StorageDto.PaymentHistorySearchRequest request) {
	...
	public ResponseEntity<StorageDto.OverdueHistorySearchResponse> searchOverdueHistories(
			@Valid @ModelAttribute StorageDto.OverdueHistorySearchRequest request) {
